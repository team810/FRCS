...
class Match(models.Model):
    ...
    control_panel_rot = models.CharField(max_length=100, null = True)
    control_panel_pos = models.CharField(max_length=100, null = True)
    robot_climb = models.CharField(max_length=100, null = True)
    robot_generator = models.CharField(max_length=5, null = True)
    defense_played = models.CharField(max_length=5, null = True)
